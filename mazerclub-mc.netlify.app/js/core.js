window.onload = function() {
    ...
    //Site title
    let title = 'Mazer Club';

    //Server Ip (counter)
    var serverIp = 'mazer.club';
    var serverIpPort = 25619;
    ...
    var trirdPlayerName = 'NuZacker';
    var trirdtPlayerComment = "I will defeat them all, wait for me!";
    //--------------------------------------------

    //Social media links / banner (url)
    var urlFacebook = "";
    var urlTwiiter = "https://www.tiktok.com/@mazerclub";
    var urlInstagram = "https://www.instagram.com/??/";
    var urlYoutube = "hhttps://www.youtube.com/channel/UCdWEps5Q8WiVmpNFFrmTUpws";
    var discordInvite = "https://discord.gg/mazerclub";
